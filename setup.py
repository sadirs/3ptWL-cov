...
setup(
    ...
    project_urls={
        'Documentation': 'https://3ptwl-cov.readthedocs.io/en/latest/',
        'Source': 'https://github.com/sadirs/3ptWL-cov',
        'Issues': 'https://github.com/sadirs/3ptWL-cov/issues',
    },
    author='Sofia Samario-Nava and Alejandro Aviles',
    author_email='ssamario@icf.unam.mx, aviles@icf.unam.mx',
    license='MIT',
    python_requires='>=3.8',
    install_requires=[
        'numpy>=1.22',
