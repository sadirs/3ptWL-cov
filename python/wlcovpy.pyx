...
#E
    ...
    def __cinit__(self, default=False):
        ...
        try:
          ...
          resource_files = getattr(importlib.resources, "files", None)
          if resource_files is None:
            raise AttributeError("importlib.resources.files is unavailable")
          resource_path = abspath(resource_files('wlcovpy'))
